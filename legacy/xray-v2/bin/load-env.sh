...
xray_load_env() {
    ...
    if [ -z "${XRAY_DNS_SERVERS_JSON:-}" ]; then
    ...
    case "${ENABLE_IPV6}" in
        1|true|TRUE|yes|YES|on|ON)
            ...
            XRAY_DIRECT_DOMAIN_STRATEGY="UseIP"
            XRAY_PROXY_DIALER_DOMAIN_STRATEGY="UseIP"
            NFT_ROUTER_IPV6_DISABLE_RULE=""
            NFT_CLIENT_IPV6_DISABLE_RULE=""
            ;;
        *)
            ENABLE_IPV6=0
            XRAY_DNS_QUERY_STRATEGY="UseIPv4"
            XRAY_DIRECT_DOMAIN_STRATEGY="UseIPv4"
            XRAY_PROXY_DIALER_DOMAIN_STRATEGY="UseIPv4"
            NFT_ROUTER_IPV6_DISABLE_RULE='meta nfproto ipv6 counter drop comment "router ipv6 disabled"'
            NFT_CLIENT_IPV6_DISABLE_RULE='meta nfproto ipv6 counter drop comment "client ipv6 disabled"'
            ;;
    esac
    ...
    export XRAY_DNS_SERVERS_JSON XRAY_DNS_QUERY_STRATEGY XRAY_DIRECT_DOMAIN_STRATEGY XRAY_PROXY_DIALER_DOMAIN_STRATEGY
    export NFT_ROUTER_IPV6_DISABLE_RULE NFT_CLIENT_IPV6_DISABLE_RULE
